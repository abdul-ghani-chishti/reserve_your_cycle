...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('booking')->name('booking.')->group(function () {
        ...
        // Admin Cycle
        Route::get('admin_cycle_reservation', [CycleBookingController::class, 'admin_cycle_reservation'])->name('admin_cycle_reservation'); // admin cycle reservation history
        Route::get('admin_cycle_reservation_list', [CycleBookingController::class, 'admin_cycle_reservation_list'])->name('admin_cycle_reservation_list'); // admin cycle reservation history
    });
