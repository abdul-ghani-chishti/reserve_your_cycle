            ...
            <div class="content-body">
                <div class="card">
                    <div class="card-content text-center">
                        <div class="card-body">
                            <h1 class="">You are viewing cycle : {{$cycles['brand'].'-'.$cycles['type'].'-'.$cycles['model']}}</h1>
                            <p>Please select the available slots</p>
                            <div style="text-align:left">
                                <p>Available Date : {{$cycles['available_date']}}</p>
                                <p>Available Slots</p>
                                @foreach($cycles_availabilities as $cycles_availabily)
                                    <label>
                                        <input type="checkbox" name="available_hours[]" value="{{ $cycles_availabily->id }}">
                                        <span>{{ $cycles_availabily->available_hours }}</span>
                                    </label>
                                    <br>
                                @endforeach
                            </div>
                            ...
                            <!-- cycle images -->
                            <div class="row">
                                @foreach($cycle_images as $cycle_image)
                                    <div class="column">
                                        <img src="{{asset($cycle_image['cycle_image_path'])}}" class="myFunction" alt="Nature" style="width:100%">
                                    </div>
                                @endforeach
                            </div>
